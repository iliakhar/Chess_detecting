...
class ChessBoardDetecting:
    ...
    def __init__(self):
        ...
        self.img_min_size: int = 400

        self.conv_model: ConvNet = ConvNet()
        self.conv_model = self.conv_model.to(self.conv_model.device)
        self.conv_model.load_model(getcwd() + '\\lattice_points_ml\\model\\model_30_500.pt')
    ...
    def show_borders(self, is_wait: bool = True):
        ...
        draw_lines(self.img, [self.lattice_points.borders, LatticePoints.const_borders], colors, is_wait)
    ...
    def show_grupped_points(self, is_wait: bool = True, img_name: str = 'image3'):
        ...
        lt = self.lattice_points
        points = [self.intersection_points, lt.lattice_points, [LatticePoints.board_center_list[-1]], lt.bp, [LatticePoints.const_board_center]]
